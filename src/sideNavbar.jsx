        ...
        >
          ...
          <div className="flex gap-2 items-end justify-end  pt-2">
            <button
              ...
              className="bg-[--secondary-color] flex items-center border-2 border-slate-600 shadow-md justify-center px-2 text-white lg:w-[4vw] lg:px-0 lg:h-[4vh] rounded-md "
            >
              Yes
            </button>
            <button
